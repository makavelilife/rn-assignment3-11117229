...
import workImage from './assets/praying.jpg';
import healthImage from './assets/eating.jpg';
import fitnessImage from './assets/walking.jpg';
import lifestyleImage from './assets/dancing.jpg';
import readingImage from './assets/sleeping.jpg';
import musicImage from './assets/running.jpg';
    ...
    <ScrollView contentContainerStyle={styles.Task}>
      <View style={styles.Group1050}>
        ...
        <View style={styles.Group9}>
          <View style={styles.CategoriesCard}>
            <View style={styles.Group7}>
              <Text style={styles.Reading}>Relaxing</Text>
              <Text style={styles._12Tasks}>12 Tasks</Text>
            </View>
            <Image
              style={styles.CategoryImage}
          ...
          <View style={styles.CategoriesCard1}>
            <View style={styles.Group71}>
              <Text style={styles.Music}>Running</Text>
              <Text style={styles._12Tasks1}>12 Tasks</Text>
            </View>
            <Image
              style={styles.CategoryImage}
